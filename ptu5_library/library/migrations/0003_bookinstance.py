    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unique_id', models.UUIDField(default=uuid.uuid4, verbose_name='unique_id')),
                ('due_back', models.DateField(blank=True, null=True, verbose_name='due back')),
                ('status', models.CharField(choices=[('m', 'managed'), ('t', 'taken'), ('a', 'availible'), ('r', 'reserved')], default='m', max_length=1, verbose_name='status')),
